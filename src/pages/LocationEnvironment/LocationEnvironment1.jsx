...
const locationSections = [
  ...
  },
  {
    ...
    contentText:
      "공원과 녹지 공간을 가까이 누리는 쾌적한 생활환경<br />실거주와 미래가치를 함께 고려한 고덕 제일풍경채",
  },
];
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.textBox}>
        ...
        <div>고덕 제일풍경채가 새로운 주거 가치로 찾아옵니다.</div>
      </div>
      ...
      <figure className={styles.locationMapFrame}>
        <img
          ...
          alt="고덕 제일풍경채 입지환경과 고덕국제화계획지구 생활권 안내 이미지"
        />
        <button
          type="button"
          ...
          onClick={() =>
            openZoom(
              page1,
              "고덕 제일풍경채 입지환경과 고덕국제화계획지구 생활권 안내 이미지"
            )
          }
        ...
        {locationSections.map((value) => (
          <LocationSectionBox
            ...
            onZoom={() =>
              openZoom(
                value.img,
                `고덕 제일풍경채 ${value.titleText.replace(/<[^>]*>/g, " ")} 이미지`
              )
            }
          />
        ))}
