const footerData = {
  ...
  phone: "1533-8848",
  description:
    "본 홈페이지는 고덕 제일풍경채 분양 정보를 안내하기 위한 대표 홈페이지입니다. 이미지와 CG, 일러스트, 개발 계획은 소비자의 이해를 돕기 위한 것으로 실제와 차이가 있을 수 있습니다.",
  notice:
  ...
  familySites: [
    {
      name: "고덕 제일풍경채",
      url: "http://gd-jeilpunggyeongchae.co.kr/",
    },
  ],
  links: [
  ...
  copyright:
    "COPYRIGHT 2026 GODEOK SUJAIN. ALL RIGHTS RESERVED.",
};
